...
@NoArgsConstructor
public class IntegerOrderedInoutOutputStream extends OrderedInputOutputStream<Integer> {
    ...
    @Override
    public void write(Cell<Integer> data, InputOutputStream toInputOutputStream) {
        // TODO: writing
    }
}
